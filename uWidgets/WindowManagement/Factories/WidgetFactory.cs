...
public class WidgetFactory : IWidgetFactory
{
    ...
    public WidgetFactory(IServiceProvider serviceProvider, List<WidgetLayout> widgetLayouts, ILayoutService layoutService)
    {
    ...
    private WidgetBase CreateWidget(WidgetLayout widgetLayout)
    {
        ...
        widget.WidgetResized += (columns, rows, animate) => LayoutService.OnWidgetResize(widget, columns, rows, animate);
        widget.Show();
