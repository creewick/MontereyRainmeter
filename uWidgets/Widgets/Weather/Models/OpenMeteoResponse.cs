...
{
    [JsonPropertyName("hourly")] public OpenMeteoHourlyForecast Hourly { get; set; }

    [JsonPropertyName("daily")] public OpenMeteoDailyForecast Daily { get; set; }
}
...
public class OpenMeteoDailyForecast
{
    ...
    [JsonPropertyName("weathercode")] public List<WeatherCode> WeatherCode { get; set; }
}
